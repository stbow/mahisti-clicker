 ...
 * @property {string} research1.id - DOM element id
 * @property {string} research1.priceTag - displayed price
 * @property {string} research1.description - displayed description
 * @property {function(): boolean} research1.trigger - when to display
 * @property {number} research1.uses
 * @property {function(): boolean} research1.cost - whether user can afford
 * @property {number} research1.flag - 0 if not used, 1 if used
 * @property {?Element} research1.element
...
var research59 = {
  ...
  description: "Promote unity through national events (one-time happiness boost)", //TODO add happiness effect to description
...
var research68 = {
  ...
  priceTag: function() { return ((-500 * research68.uses) + 2500).toLocaleString() + " research points"},
  description: "Sell breakthroughs from the empire's inventors to foreign buyers",
  trigger: function() {return research53.flag === 1 && balance <= 300000000 && researchPoints >= 500},
  uses: 4,
  cost: function() {return researchPoints >= ((-500 * research68.uses) + 2500)},
  flag: 0,
  element: null,
  effect: function() {
    research68.flag = 1;
    balance += (-72000000 * research68.uses) + 720000000;
    // first use = 432mil, goes UP by 72mil each time
    researchPoints -= (-500 * research68.uses) + 2500;
    // first use = 500 points, goes UP by 500 each time
    pointsCount.innerText = researchPoints;
