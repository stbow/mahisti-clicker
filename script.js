...
const employeesPSText = document.getElementById("emp-ps");
...
const shopsPSText = document.getElementById("shops-ps");
...
const fleetPSText = document.getElementById("fleet-ps");
...
const minesPSText = document.getElementById("mines-ps");
